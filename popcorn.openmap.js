...
(function (Popcorn) {
   ...
   * Based on the googlemap popcorn plug-in, except location option not available
  ...
  Popcorn.plugin( "openmap" , (function(){
    ...
    return {
      ...
      _setup : function( options ) {
        ...
        // geolocation to be added through Yahoo Maps JSONP
            ...
            if( options.markers ){
              setInterval( function() {
                for( var m=0; m<options.markers.length; m++ ) {
                  ...
                  if( myMarker.isOn ) {
                    //marker is shown; check if marker should be removed
                    ...
                    //marker is hidden; check if marker should be added
                    if( ( myMarker.popcorn.popped.currentTime() > myMarker.start ) && ( myMarker.popcorn.popped.currentTime() < myMarker.end ) ) {
